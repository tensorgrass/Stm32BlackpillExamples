...
#define ESC_MID 1800//2047 // Midpoint for ESC
#define ESC_FORWARD_MAX 3000//3000 // Minimum PWM value for ESC
#define ESC_INC 20 // Minimum PWM value for ESC
...
//  HAL_Delay(1000);
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
        ...
        HAL_Delay(2000); // Espera 100 milisegundos
