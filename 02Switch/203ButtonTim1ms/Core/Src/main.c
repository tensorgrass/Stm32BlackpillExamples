...
uint8_t button_buffer[BUFFER_SIZE];
...
int main(void)
{
  ...
  MX_TIM2_Init();
  /* USER CODE BEGIN 2 */
  HAL_TIM_Base_Start_IT(&htim2); // Inicia el timer en modo interrupción
  /* USER CODE END 2 */
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
    ...
    {
        // Leer PB13 y guardar en buffer circular
        button_buffer[buffer_index] = (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13) == GPIO_PIN_RESET) ? 0 : 1;
